...
function KBParallelTestModule(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.do_something = function (p, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "KBParallelTestModule.do_something",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "KBParallelTestModule.status",
