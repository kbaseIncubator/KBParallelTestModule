...
class KBParallelTestModule(object):
    ...
    def do_something(self, p, context=None):
        """
        ...
        return self._client.call_method(
            'KBParallelTestModule.do_something',
            [p], self._service_ver, context)

    def status(self, context=None):
        return self._client.call_method('KBParallelTestModule.status',
